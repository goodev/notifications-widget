	...
	public RemoteViews getViewAt(int position) 
	{
		...
		if (s != null) 
		{
		    ...
		    if (notifications.size() >0 && position < notifications.size())
		    {
				...
				row.setInt(R.id.notificationBG, "setBackgroundColor", Color.argb(Color.alpha(bgColor) *  opacity  / 100, Color.red(bgColor), Color.green(bgColor), Color.blue(bgColor)));
                ...
                if (!notStyle.equals("compact"))
                {
                    ...
                    styleView.setInt(R.id.notificationIconBG, "setBackgroundColor", Color.argb(Color.alpha(bgColor) * opacity / 100, Color.red(iconBgColor), Color.green(iconBgColor), Color.blue(iconBgColor)));
                }
